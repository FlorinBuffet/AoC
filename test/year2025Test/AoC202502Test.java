...
class AoC202502Test {
    ...
    private static final long PERSONAL_RESULT_PART1 = 24043483400L;
    private static final long PERSONAL_RESULT_PART2 = 38262920235L;
    ...
    void partOneSampleA(String sample, long expectedResult) throws Exception {
    ...
    private static Stream<Arguments> inputAndResultsSamples() {
        return Stream.of(Arguments.of("a", 1227775554, 4174379265L));
    }
}