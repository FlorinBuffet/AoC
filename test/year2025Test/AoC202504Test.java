...
class AoC202504Test {
    ...
    private static final int PERSONAL_RESULT_PART1 = 1604;
    private static final int PERSONAL_RESULT_PART2 = 9397;
    ...
    @MethodSource("inputAndResultsSamples")
    void partTwoSampleA(String sample, long irrelevant, int expectedResult) throws Exception {
    ...
    private static Stream<Arguments> inputAndResultsSamples() {
        return Stream.of(Arguments.of("a", 13, 43));
    }
}