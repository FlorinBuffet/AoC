...
class AoC202509Test {
    ...
    private static final long PERSONAL_RESULT_PART1 = 4741451444L;
    private static final long PERSONAL_RESULT_PART2 = 347468726696961L;
    ...
    private static Stream<Arguments> inputAndResultsSamples() {
        return Stream.of(Arguments.of("a", 50, 14));
    }
}